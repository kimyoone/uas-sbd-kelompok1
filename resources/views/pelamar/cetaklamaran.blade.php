     ...
     <div id=halaman>
         ...
         <table>
             <tr>
                 ...
                 <td style="width: 5%;">:</td>
                 <td style="width: 65%;">KAPRODI STMIK BANDUNG</td>
             </tr>
             <tr>
         ...
         <p align = "justify">Mahasiswa yang bersangkutan telah disetujui untuk melakukan <strong>KERJA PRAKTEK.</strong> Yang bersangkutan dapat melaksanakan agenda KERJA PRAKTEK lebih lanjut, 
            sesuai jadwal perkuliahan yang sudah ditentukan.</p>
     
         <div style="width: 30%; text-align: left; float: right;">Bandung, {{date('d-m-Y')}}</div><br><br> 
         <div style="width: 30%; text-align: left; float: right;">Yang bertanda tangan,</div><br><br><br><br><br>
         <div style="width: 30%; text-align: left; float: right;">KAPRODI STMIK BANDUNG</div>
